...
/**
 * Seeds the database if empty or forced
...
const seedDatabase = async (force = false) => {
  try {
    ...
    if (userCount > 0 && !force) {
      console.log(`[Database] Database already contains ${userCount} users. Auto-seed skipped.`);
      return;
    }

    console.log('[Database] Auto-seeding default demo users & Chennai accommodations...');
    ...
    console.log('[Database] ✅ Default accounts & Chennai properties seeded successfully!');
    console.log('[Database] 👤 Tenant:  tenant@example.com / password123');
    console.log('[Database] 🏢 Owner:   owner@example.com  / password123');
    console.log('[Database] 🛡️ Admin:   admin@example.com  / password123');
  } catch (err) {
